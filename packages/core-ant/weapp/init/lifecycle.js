...
import { initHooks } from '../../../core/weapp/init/hooks';
import { initProps } from './props';
import { initWatch } from '../../../core/weapp/init/watch';
import { initRender } from '../../../core/weapp/init/render';
import { initData } from '../../../core/weapp/init/data';
import { initComputed } from '../../../core/weapp/init/computed';
import { initMethods } from './methods';
import { initEvents } from '../../../core/weapp/init/events';
import { isStr, isArr, isFunc } from '../../../core/shared/index';
import Dirty from '../../../core/weapp/class/Dirty';
import { WEAPP_APP_LIFECYCLE, WEAPP_PAGE_LIFECYCLE, WEAPP_COMPONENT_LIFECYCLE } from '../../../core/shared/index';
import { warn } from '../../../core/weapp/util/index';
...
export function patchLifecycle (output, options, rel, isComponent) {
  ...
  if (isComponent) {
    ...
    output.onShow = function (...args) { // Page attached 
      let vm = this.$wepy;
      let app = vm.$app;
